...
class AVHubertSeq2Seq(FairseqEncoderDecoderModel):
    ...
    def forward(self, **kwargs):
        ...
        #print('$$$$$$ encoder output.shape, padding_mask, enc_padding mask in asr', output['encoder_out'].shape, output['padding_mask'].shape, output['encoder_padding_mask'].shape, torch.equal(output['encoder_padding_mask'],output['padding_mask']))
        #print(self.decoder)
        print(kwargs)
        #print(kwargs['prev_output_tokens'])
