#python -m torch.distributed.launch --nproc_per_node 2 train.py --checkpoint_path /ssd_scratch/cvit/neha/checkpoints/ --config configs/vctkiemo/hubert100_lut.json
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            if rank == 0:
                start_b = time.time()
            x, y, _, y_mel = batch
            #print("in train: xcode:",x['code'].shape, y.shape)
